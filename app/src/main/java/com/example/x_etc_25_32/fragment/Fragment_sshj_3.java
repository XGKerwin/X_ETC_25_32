 ...
 * date   : 2020/12/5 9:44
 */
public class Fragment_sshj_3 extends Fragment {
    ...
    public Fragment_sshj_3(List<SSHJ> sshjList) {
    ...
    private void getData() {
        ...
        for (int i=0;i<sshjList.size();i++){
            ...
            entryList.add(new Entry((i+1)*3,sshj.getIllumination()));
            colors.add(Color.parseColor("#0BFA10"));
        }
